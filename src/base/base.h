...
template <class T>
inline View<T> MakeView(T const *z, size_t n) {
    return View<T>{z, n};
}

template <class T>
inline MutView<T> MakeMutView(T *z, size_t n) {
    return MutView<T>{z, n};
}
...
// Unittest Uilts
#define FRIEND_UNITTEST_CASE(test_name, test_case) friend class test_name##_##test_case##_Test
...
#define NYAA_ARCH_X64 1
#endif

#if defined(__ARM64_ARCH_8__)
#define NYAA_ARCH_ARM64 1
#endif

#define NOREACHED() DLOG(FATAL) << "Noreached! "
#define TODO() DLOG(FATAL) << "TODO: "

enum Initializer { LAZY_INSTANCE_INITIALIZER, ON_EXIT_SCOPE_INITIALIZER };
